function toggleReveal() {
  ...
  reveals.forEach((reveal) => {
    ...
    expand.addEventListener("click", () => {
      ...
      expand.innerHTML = !status
        ? 'Collapse text <ion-icon name="chevron-up-outline"></ion-icon>'
        : 'Expand text <ion-icon name="chevron-down-outline"></ion-icon>';
    });
  });
}
